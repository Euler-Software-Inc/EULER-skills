...
`customer | partner | both`. `my-referrals` is partner-scope; called from a
...
> "my-referrals shows your own referrals as a partner. You're connected as a customer
> admin — to triage the approval queue use `pending-approvals-triage`, or open your
